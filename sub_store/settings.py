"""
Django settings for sub_store project.
...
SECRET_KEY = 'django-insecure-cddm897frcse79!4rpyw7i!hl4hu-p+=^1=al-f!2l=idp&^tc'
...
WSGI_APPLICATION = 'sub_store.wsgi.application'
